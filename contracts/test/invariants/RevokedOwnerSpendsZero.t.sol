...
contract RevokedOwnerSpendsZeroInvariant is RegistryFixture {
    ...
    function setUp() public override {
        ...
        handler =
            new PayerHandler(registry, stamp, bzz, DEFAULT_DEPTH, DEFAULT_BUCKET, GRACE_BLOCKS);
    ...
    function invariant_spentMatchesAllowed() public view {
        for (uint256 i = 0; i < 3; ++i) {
            ...
            assertEq(handler.spentByPayer(p), handler.allowedByPayer(p), "revoked-owner spend leak");
        }
    }
}
